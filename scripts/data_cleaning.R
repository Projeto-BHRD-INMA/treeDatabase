...
library(data.table)
#?fread
spp.gbif.table <- fread("D:/01_INMA_BHRD/bancoDados/species_gbif_MG_ES_20_08_2020.csv")
...
write.csv(data_clean3, "D:/01_INMA_BHRD/bancoDados/species_gbif_MG_ES_20_08_2020_clean.csv")

## to write the new table
write.csv(data_clean_F, "D:/01_INMA_BHRD/bancoDados/species_gbif_MG_ES_20_08_2020_false.csv")
...
bhrd <- readOGR("D:/01_INMA_BHRD/GIS/bhrd_wgs84.shp") #loading shapefile
...
#Save figure
png("D:/01_INMA_BHRD/bancoDados/spp_bhrd.png", res = 300, width = 2400, height = 2400)
figura
